...
class CreateSupplierQuoteWizard(models.TransientModel):
    ...
    def action_create_quote(self):
        ...
        # Link existing standard PO if it was generated by the RFQ
        for std_po in self.rfq_id.standard_po_ids:
            if std_po.partner_id == self.supplier_id:
                quote.standard_po_id = std_po.id
                break
